...
using OrderManagement.Common.BaseTypes;
using OrderManagement.ProductService.Core.Dtos;

namespace OrderManagement.ProductService.Tests
{
    public class ProductServiceTests
    {
        private readonly Mock<IProductRepository> _mockRepository;
        private readonly Mock<ILogger<OrderManagement.ProductService.Services.ProductService>> _mockLogger;
        private readonly IProductService _productService;

        public ProductServiceTests()
        {
            _mockRepository = new Mock<IProductRepository>();
            _mockLogger = new Mock<ILogger<OrderManagement.ProductService.Services.ProductService>>();
            _productService = new OrderManagement.ProductService.Services.ProductService(_mockRepository.Object, _mockLogger.Object);
        }
