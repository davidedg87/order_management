...
namespace OrderManagement.UserService.Services
{
    public class UserServiceTests
    {
        ...
        private readonly Mock<ILogger<OrderManagement.UserService.Services.UserService>> _loggerMock;
        private readonly OrderManagement.UserService.Services.UserService _userService;

        public UserServiceTests()
        {
            _userRepositoryMock = new Mock<IUserRepository>();
            _loggerMock = new Mock<ILogger<OrderManagement.UserService.Services.UserService>>();
            _userService = new OrderManagement.UserService.Services.UserService(_userRepositoryMock.Object, _loggerMock.Object);
        }
