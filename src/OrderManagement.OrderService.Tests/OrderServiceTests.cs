...
namespace OrderManagement.OrderService.Tests
{
    public class OrderServiceTests
    {
        ...
        public OrderServiceTests()
        {
            ...
            _orderService = new OrderManagement.OrderService.Services.OrderService(_mockOrderRepository.Object, _mockLogger.Object);
        }
